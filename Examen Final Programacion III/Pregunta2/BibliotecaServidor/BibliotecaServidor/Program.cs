        ...
        public static void StartListening()
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    string a = MensajeCompuesto[1];
                    string b = MensajeCompuesto[2];
                    string c = MensajeCompuesto[3];
                    string d = MensajeCompuesto[4];
                    Estado estado;
                    Enum.TryParse(d, out estado);


                    switch (Operacion)
                    {
                        case "1":
                            Libro librex = new Libro(a, b, c, estado);
                            o.InsentarLibro(librex);
                            break;
                        case "2":
