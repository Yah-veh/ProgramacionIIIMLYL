...
namespace BibliotecaCliente
{
    class ClienteSincrono
    {
        ...
        public void CalcularOperacion(string operacion, string a, string b, string c, string d)
        {
            string cadena = operacion + "," + a + "," + b+"," + c+"," + d;
        ...
        public string Mostrar(string operacion)
        {
